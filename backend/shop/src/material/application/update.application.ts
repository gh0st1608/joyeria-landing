...
import { CategoryProduct, CategoryProductPropertiesUpdate } from '../domain/entities/material.entity';
import { ICategoryProductRepository } from '../domain/repository/material.repository'
